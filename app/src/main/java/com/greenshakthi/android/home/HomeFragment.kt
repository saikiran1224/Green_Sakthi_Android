...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        // TODO: Need to set the Diesel price automatically from DB
        ...
        addToCartLayout.setOnClickListener {
            ...
            if (itemQuantity.text.equals("Add to Cart")) {
                ...
                txtFinalPrice.text = ((itemQuantity.text.toString().toInt() *txtDieselPrice.text.toString().toInt()).toString())
        ...
        itemMinus.setOnClickListener {
            ...
            if (tempQuantity < 10 ) {
                ...
                // disappearing the Final Price Material Card Viww
